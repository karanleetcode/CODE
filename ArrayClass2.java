...
//d
        ...
        arrayList.add(new Contacts(670,"Rebuke","to criticize","I was rebuked by my manager for being late.","0","reprove/reprimand/check/chide/admonish/burn one"));
        arrayList.add(new Contacts(671,"Recant","formally reject","After a year spent in solitary confinement, he publicly recanted (his views).","0","renounce/revoke/abjure/revoke/give up/abnegate"));
        arrayList.add(new Contacts(672,"Recoil","spring back","He leaned forward to kiss her and she recoiled in horror.","0","dengenerate/rebound/blench/cringe/quail/flinch"));
        arrayList.add(new Contacts(673,"Recondite","difficult to penetrate","We had to work from material that was both complex and recondite.","0","deep/concealed/abstruse/arcane/esoteric/hermetic"));
        arrayList.add(new Contacts(674,"Redolent","having a strong bad odor","The album is a heartfelt cry, redolent of a time before radio and television.","0","odorous/aromatic/scented/evocaticve/suggestive/ambrosial"));
        arrayList.add(new Contacts(675,"Redress","make amends","Most managers, politicians and bosses are men - how can women redress the balance.","0","avenge/heal/remedy/correct/compensate/suitable"));
        arrayList.add(new Contacts(676,"Refute","to over throw","to refute a person/theory/argument/claim","0","erroneous/contradict/disaffir/disclaim/disconfirm/negative"));
        arrayList.add(new Contacts(677,"Relegate","assign to a lower position","She resigned when she was relegated to a desk job.","0","banish/assign/delegate/deport/displace/exile/banish"));
        arrayList.add(new Contacts(678,"Remiss","falling in what duty requires","You have been remiss in your duties.","0","negligent/careless/lax/lazy/neglectful/neglecting"));
        arrayList.add(new Contacts(679,"Remote","isolate","remote galaxies","0","islolated/secluded/divergent/aloof/slight/fragile/negligible"));
        arrayList.add(new Contacts(680,"Remuneration","paying for goods and services","They demanded adequate remuneration for their work.","0","compensation/disbursement/remitment/remittance/giving/payment"));
        arrayList.add(new Contacts(681,"Repent","to repay","He repented (of his sins) just hours before he died.","0","bemoan/lament/deplore/regret/rue/penitent/creeping"));
        arrayList.add(new Contacts(682,"Repertoire","the range of skills in a occupation","The Royal Shakespeare Company also have many modern plays in their repertoire.","0","expedient/budget/force/fund/inventory/supply/stock"));
        arrayList.add(new Contacts(683,"Replenish","fll something back","Food stocks were replenished by/with imports from abroad.","0","replace/perfect/nourish/stock/full/repay"));
        arrayList.add(new Contacts(684,"Replete","filled to satisfaction","After two helpings of dessert, Sergio was at last replete.","0","full/complete/stout/blubbery/chubby/corpulent/fleshy/gross"));

        arrayList.add(new Contacts(685,"Repose","freedom","She reposed on the sofa.","0","lie/rely/rest/catnapping/resting/sleep"));
        arrayList.add(new Contacts(686,"Reprehensible","deserving blame","reprehensible conduct/actions","0","culpable/blamable/censurable/blameworthy/reproachable/blame"));
        arrayList.add(new Contacts(687,"Repress","concean or hide","He repressed a sudden desire to cry.","0","subdue/clamp down/crack down/put down/quell/snuff/silence"));
        arrayList.add(new Contacts(688,"Reprimand","to scold","She was reprimanded by her teacher for biting another girl.","0","commination/condemnation/comtempt/reproach/riot/stricture"));
        arrayList.add(new Contacts(689,"Reproach","to criticize","His mother reproached him for not eating all his dinner.","0","commination/condemnation/comtempt/reproach/riot/stricture"));
        arrayList.add(new Contacts(690,"Repudiate","to refuse to achknowledge","He repudiated the allegation/charge/claim that he had tried to deceive them.","0","decline/contradict/disaffirm/negative/refute/deny"));
        arrayList.add(new Contacts(691,"Repugnant","offensive to mind","I find your attitude towards these women quite repugnant.","0","incompatible/hostile/inconsistent/abhorrent/abominable/appalling"));
        arrayList.add(new Contacts(692,"Repulse","force or drive back","The enemy attack was quickly repulsed.","0","repel/repulsion/gross out/nauseate/revolt/sicken"));
        arrayList.add(new Contacts(693,"Requisite","necessary","He lacked the requisite skills for the job.","0","essential/necessary/critical/needed/essential/vital"));
        arrayList.add(new Contacts(694,"Resourceful","adroit and imaginative","She's a very resourceful manager.","0","adroit/skillful/adept/apt/caliber/imaginative"));
        arrayList.add(new Contacts(695,"Respite","a pause from doing something","We worked for hours without respite.","0","interval/put off/delay/relief/temporary delay/stop"));
        arrayList.add(new Contacts(696,"Restrictive","serving to limit","He is self-employed because he finds working for other people too restrictive.","0","restrict/stint/negotiate/limting/fencing/boundry"));
        arrayList.add(new Contacts(697,"Reticent","reserved","He is very reticent about his past.\n","0","silent/reserved/close/closemouthed/dark/secretive/uncommunicative"));
        arrayList.add(new Contacts(698,"Retort","quick reply","\"That doesn't concern you!\" she retorted.","0","return/retaliate/answer/reply/say/counter reply"));
        arrayList.add(new Contacts(699,"Retrospect","look within oneself","In retrospect, I think my marriage was doomed from the beginning.","0","reappraisal/reconsideration/reexamination/review/retrospection/review"));
        arrayList.add(new Contacts(700,"Revere","respect","Nelson Mandela is revered for his brave fight against apartheid.","0","adore/respect/worship/glorify/venerate/reverence/deify"));

        arrayList.add(new Contacts(701,"Revert","turn back","He has to revert back to the sitaution","0","reversion/reverse/retrogress/return/regress/come back"));
        arrayList.add(new Contacts(702,"Revile","abusive language","The minister was attacked by some revile language","0","scold/rail/vituperate/invective/critical/insult"));
        arrayList.add(new Contacts(703,"Rhetoric","study of technique for using language effectively","I was swayed by her rhetoric into donating all my savings to the charity.","0","verbal/language/bombast/fustian/hot air/verbiage/wind"));
        arrayList.add(new Contacts(704,"Rife","abundant","Dysentery and malaria are rife in the refugee camps.","0","abonding/abundant/awash/fraught/flush/swarming/thick"));
        arrayList.add(new Contacts(705,"Rift","a narrow fissure","The stream had cut a deep rift in the rock.","0","breach/fissure/fault/estrangement/cleft/cranny"));
        arrayList.add(new Contacts(706,"Roster","list","If you look on the duty roster, you'll see when you're working.","0","canon/catalog/checklist/listing/menu/registry"));
        arrayList.add(new Contacts(707,"Rudimentary","early stages","Her knowledge is still only rudimentary.","0","vestige/crude/low/rude/primitive/basic/simple"));
        arrayList.add(new Contacts(708,"Rue","feel sorry for","He was quite rueful after his death.","0","sorrow/bemoan/deplore/lament/repent/regret"));
        arrayList.add(new Contacts(709,"Ruminate","reflect deeply","She ruminated for weeks about whether to tell him or not.","0","ponder/chew over/cogitate/consider/debate/contemplate"));
        arrayList.add(new Contacts(710,"Rustic","characteristic of rural life","a rustic bench/cabin","0","clumsy/gauche/graceless/inelegant/awkward/wooden"));
        arrayList.add(new Contacts(711,"Sabbatical","a leave taken every seventh day","to take/have a sabbatical","0","leave/respite/holiday/leave off/sabbath/take off"));
        arrayList.add(new Contacts(712,"Sage","wise saying","my sage old grandfather","0","grave/solemn/wise/discerning/insightful/prudent"));
        arrayList.add(new Contacts(713,"Salient","quality that thrust itself into attention","She began to summarize the salient features/points of the proposal.","0","noticeable/jumping/prominent/conspicously/important/gaudy"));
        arrayList.add(new Contacts(714,"Salubrious","healthy","He doesn't live in a very salubrious part of town.","0","good/healthy/salutary/medicinal/restorative/sanative/salutiferous"));
        arrayList.add(new Contacts(715,"Salvation","preserving from harm","After the diagnosis, getting to know Mary was his salvation.","0","deliverance/rescue/save/safeguard/bodyguard/uncathed"));
        arrayList.add(new Contacts(716,"Sanctimonious","hyptocritically pious","sanctimonious religious leaders preaching about morality","0","holiness/god/sanctity/holy/morals/devout"));
        arrayList.add(new Contacts(717,"Sanction","offical approval","Many nations have imposed sanctions on the country ","0","allowance/authorization/clearance/consent/concurrence/permission/sufferance"));
        arrayList.add(new Contacts(718,"Sanctuary","a concecrated place where sacred objects are kept","Illegal immigrants found/sought/took sanctuary in a local church.","0","shrine/sanctum/refuge/church/temple/room"));
        arrayList.add(new Contacts(719,"Sanguine","optimistic and cheerful","They are less sanguine about the prospects for peace.","0","ruddy/optimistic/ruddy/bloodred/bloodthirsty/confident"));
        arrayList.add(new Contacts(720,"Satiety","to satisfy","A good way to feel satiety and eat healthy while at a party is to fill your plate with vegetables first","0","surfeit/fullness/satisfied/full/satiated/complete"));
        arrayList.add(new Contacts(721,"Saturate","to fill to the brim","The grass had been saturated by overnight rain.","0","soak/satiate/saturate/awash/bathed/bedraggled"));
        arrayList.add(new Contacts(722,"Schism","division of a group into opposing factors","a schism in/within the Church","0","discord/separation/disharmony/division/conflict/disaccord"));
        arrayList.add(new Contacts(723,"Scion","a descendant or heir","He's the scion of a very wealthy newspaper-publishing family.","0","descendant/child/heir/cutting/graft/slip"));
        arrayList.add(new Contacts(724,"Scoff","laugh at with contempt and derision","The critics scoffed at his paintings.","0","mock/deride/ridicule/sneer/dismiss/belittle"));

        arrayList.add(new Contacts(725,"Scrutinize","examine carfully","He scrutinized the men's faces carefully/closely, trying to work out who was lying","0","examine/critical/survey/study/peruse/inspect"));
        arrayList.add(new Contacts(726,"Scurrilous","expressing offensive reproach","a scurrilous remark/attack/article","","invective/contumelious/abusive/truculent/vituperative/vitriolic"));
        arrayList.add(new Contacts(727,"Scurry","to move about","The mouse scurried across the floor.","","dainty/move/small steps/move forward/scamper/brisk pace"));
        arrayList.add(new Contacts(728,"Sedate","characterized by dignity","The boy is quite sedate in his demeanor.","","serious/slow/relaxed/unruffled/quiet/peaceful"));
        arrayList.add(new Contacts(729,"Sedentary","requiring seating","My doctor says I should start playing sport because my lifestyle is too sedentary.","0","settled/sitting/staying/living/permanent/inactive"));
        arrayList.add(new Contacts(730,"Senile","infirm with age","He spent many years caring for his senile mother.","0"," doddery/ decrepit/ aged/ long in the tooth/ senescent/ failing/ declining/ infirm "));
        arrayList.add(new Contacts(731,"Serenity","calm","She has a lovely serene face.","0","calmness/ calm/ composure/ tranquillity/ peacefulness/ peace of mind/ peace, "));
        arrayList.add(new Contacts(732,"Servile","submissive and fawning with attitude","As a waiter you want to be pleasant to people without appearing totally servile.","0","obsequious/ sycophantic/ excessively deferential/ subservient/ fawning/ toadying "));
        arrayList.add(new Contacts(733,"Sinecure","an office that involves minimal duties","Ross was later demoted to a sinecure at ABC’s beleaguered Lincoln Square Productions","0","easy job/ soft option/ informalcushy number/ money for old rope/ money for jam/ picnic"));
        arrayList.add(new Contacts(734,"Singular","single","a singular ending/form/noun/verb","0","remarkable/ extraordinary/ exceptional/ outstanding/ striking/ signal/ eminent "));
        arrayList.add(new Contacts(735,"Sinister","stemming from evil","The ruined house had a sinister appearance.","0","menacing/ threatening/ ominous/ forbidding/ baleful/ frightening/ eerie/ alarming "));
        arrayList.add(new Contacts(736,"Site","the piece of land on which something is located","a building site","0","place/ put/ position/ situate/ locate/ set/ install"));
        arrayList.add(new Contacts(737,"Skirmish","a minor short term fight","There was a short skirmish between the two of them","0","fight/ battle/ clash/ conflict/ encounter/ confrontation/ engagement/ fray/ contest"));
        arrayList.add(new Contacts(738,"Slovenly","untidy","a slovenly appearance","0","scruffy/ untidy/ messy/ unkempt/ ill-groomed/ slatternly/ dishevelled/ bedraggled/ tousled"));
        arrayList.add(new Contacts(739,"Sojourn","temporary stay","My sojourn in the youth hostel was thankfully short.","0","stay/ visit/ stop/ stopover/ residence/ holiday/ vacation"));

        arrayList.add(new Contacts(740,"Solace","comfort","she sought solace in her religion","0","comfort/ consolation/ cheer/ support/ relief/joy"));
        arrayList.add(new Contacts(741,"Solicit","request","he called a meeting to solicit their views","0","ask for/ request/ apply for/ put in for/ seek/ beg/ plead for/ sue for/ crave/ canvass,"));
        arrayList.add(new Contacts(742,"Somber","grave or even gloomy","the night skies were sombre and starless","0","dark/ dark-coloured/ dull/ dull-coloured/ drab/ dingy/ shady"));
        arrayList.add(new Contacts(743,"Sophistry","a deliberately invalid argument","trying to argue that I had benefited in any way from the disaster was pure sophistry","0","specious reasoning/ the use of fallacious arguments/ sophism/ casuistry/ quibbling/equivocation"));
        arrayList.add(new Contacts(744,"Sordid","foul and run down","the story paints a sordid picture of bribes and scams","0","seedy/ seamy/ unsavoury/ shoddy/ vile/ foul/ tawdry/ louche/ cheap/ base "));
        arrayList.add(new Contacts(745,"Spate","a sudden forceful flow","a spate of attacks on holidaymakers","0","run/ cluster/ string/ outbreak/ rash/ epidemic/ explosion/ plague "));
        arrayList.add(new Contacts(746,"Spontaneous","said or done without having bee planned","\"the audience broke into spontaneous applause\"","0","unforced/ voluntary/ unconstrained/ unprompted/ unbidden/unsolicited/ unplanned "));
        arrayList.add(new Contacts(747,"Sporadic","in intervals","sporadic fighting broke out","0","occasional/ infrequent/ irregular/ periodical/ periodic/ scattered/ patchy/ isolated/ odd"));
        arrayList.add(new Contacts(748,"Spurious","unreal","separating authentic and spurious claims","0","bogus/ fake/ not genuine/ specious/ false/ factitious/ counterfeit/ fraudulent"));
        arrayList.add(new Contacts(749,"Squeamish","easilt disgusted","I've always been squeamish about bugs","0","principled/ conscientious/ fastidious/ particular/ punctilious/ finicky/ fussy "));
        arrayList.add(new Contacts(750,"Stagnant","not growing","a stagnant ditch","0","still/ motionless/ immobile/ inert/ lifeless/ dead/ standing/ slack/ static"));
        arrayList.add(new Contacts(751,"Steep","sharp inclination","she pushed the bike up the steep hill","0","precipitous/sheer/ abrupt/ sharp/ perpendicular/ vertical/ bluff/ vertiginous "));
        arrayList.add(new Contacts(752,"Staunch","firm and dependable","a staunch supporter of the anti-nuclear lobby","0","stalwart/ loyal/ faithful/ trusty/ committed/ devoted/ dedicated/ dependable"));
        arrayList.add(new Contacts(753,"Stentorian","with a booming voice","a stentorian roar","0","loud/ booming/ thundering/ thunderous/ trumpeting/blaring/ roaring/ ear-splitting "));
        arrayList.add(new Contacts(754,"Stereotype","established belief","the stereotype of the woman as the carer","0","typecast/ pigeonhole/ conventionalize/ standardize/ categorize/ compartmentalize"));
        arrayList.add(new Contacts(755,"Stigma","a synbol of disgrace","the stigma of having gone to prison will always be with me","0","shame/ disgrace/ dishonour/stain/ taint/ blot/ blot on one's escutcheon/ blemish "));
        arrayList.add(new Contacts(756,"Stipulate","make an express demand","he stipulated certain conditions before their marriage","0","specify/ set down/ set out/lay down/ set forth/state clearly/ demand/ require/ insist on "));
        arrayList.add(new Contacts(757,"Strident","loud and harsh","his voice had become increasingly strident","0","harsh/ raucous/ rough/ grating/ rasping/ jarring/ loud/ stentorian/ shrill"));
        arrayList.add(new Contacts(758,"Strife","bitter conflict","strife within the community","0","conflict/ friction/ discord/ disagreement/ dissension/ variance/ dispute/ argument "));
        arrayList.add(new Contacts(759,"Stunt","check the grown or development","some weeds produce chemicals that stunt the plant's growth","0","inhibit/ impede/ hamper/ hinder/restrict/ retard/slow/ curb/ arrest,"));
        arrayList.add(new Contacts(760,"Stymie","hinder or prevent the progress","the changes must not be allowed to stymie new medical treatments","0","impede/ interfere with/ hamper/ hinder/ obstruct/ inhibit/ frustrate/ thwart/foil/ spoil/ stall "));
        arrayList.add(new Contacts(761,"Subjugate","make subserviant","the invaders had soon subjugated most of the population","0","conquer/ vanquish/ defeat/ crush/ quell/ quash/ gain mastery over/ gain ascendancy over"));

        arrayList.add(new Contacts(762,"Subservient","compliant and obedient","she was subservient to her parents","0","submissive/ deferential/ acquiescent/ compliant/ accommodating/ obedient/ dutiful "));
        arrayList.add(new Contacts(763,"Substantiate","establish or strengthen","they had found nothing to substantiate the allegations","0","prove/ give proof of/ show to be true/ give substance to/ support/ uphold/ back up"));
        arrayList.add(new Contacts(764,"Subterfuge","to deceive","he had to use subterfuge and bluff on many occasions","0"," deviousness/ evasion/ deceit/ deception/ dishonesty/cheating/ duplicity"));
        arrayList.add(new Contacts(765,"Succinct","brief","use short, succinct sentences","0","concise/short/ brief/compact/condensed/ crisp/ laconic/ terse/ tight/ to the point "));
        arrayList.add(new Contacts(766,"Succulent","full of juice","a succulent steak","0","juicy/ moist/ luscious/ lush/ fleshy/pulpy/ soft/ tender/ fresh/ripe"));
        arrayList.add(new Contacts(767,"Succumb","consent reluctantly","we cannot merely give up and succumb to despair","0","yield/ give in/ give way/ submit/ surrender/ capitulate/ cave in"));
        arrayList.add(new Contacts(768,"Sullen","showing a brooding ill humor","a sullen pout","0","surly/ sulky/ pouting/ sour/ morose/resentful/ glum/ moody/ gloomy/ joyless"));
        arrayList.add(new Contacts(769,"Sultry","exciting or gratifying","the sultry late summer weather had brought swarms of insects","0","humid/close/ airless/ stuffy/stifling/suffocating/ oppressive/ muggy"));
        arrayList.add(new Contacts(770,"Sumptuous","rich and superior","the banquet was a sumptuous, luxurious meal","0","lavish/ luxurious/ deluxe/ opulent/ magnificent/ resplendent/ gorgeous/ splendid"));
        arrayList.add(new Contacts(771,"Superficial","of,affecting, or being on","the building suffered only superficial damage","0","surface/ exterior/ external/ outer/ outside/ outermost/ peripheral/ slight"));
        arrayList.add(new Contacts(772,"Superfluous","more than needed","the purchaser should avoid asking for superfluous information","0","surplus/ redundant/ unneeded/ not required/ excess/extra/ spare/to spare/ remaining"));
        arrayList.add(new Contacts(773,"Supine","laying face upward","the government was supine in the face of racial injustice","0","flat on one's back/ prone/recumbent/ prostrate/stretched out/ spreadeagled/lying, "));
        arrayList.add(new Contacts(774,"Supplication","the act of asking or begging","he fell to his knees in supplication","0","plea/appeal/ petition/ solicitation/ exhortation/urge/ prayer/ invocation/suit "));
        arrayList.add(new Contacts(775,"Surfeit","indulge to satiety","a surfeit of food and drink","0","excess/ surplus/ abundance/oversupply/ superabundance/ superfluity/ overdose"));
        arrayList.add(new Contacts(776,"Surge","rise and move","flooding caused by tidal surges","0","swell/ swelling/ heaving/ billowing/ rolling/ roll/ bulging/ eddying"));
        arrayList.add(new Contacts(777,"Surmise","infer from incomplete evidence","he surmised that something must be wrong","0","guess/ conjecture/ suspect/ deduce/ infer/come to the conclusion/ conclude"));
        arrayList.add(new Contacts(778,"Surreptitious","marked by secrecy","low wages were supplemented by surreptitious payments from tradesmen","0","secret/ stealthy/ clandestine/ secretive/sneaky/sly/ furtive/ concealed"));
        arrayList.add(new Contacts(779,"Susceptible","yielding","patients with liver disease may be susceptible to infection","0","liable to/prone to/ subject to/ inclined to/ predisposed to/disposed to/ given to"));
        arrayList.add(new Contacts(780,"Symptomatic","relating to sensations experienced","these difficulties are symptomatic of fundamental problems","0","indicative/ signalling/ warning/ characteristic/ suggestive/ typical/ representative"));
        arrayList.add(new Contacts(781,"Taboo","a ban resulting from social custom","many taboos have developed around physical exposure","0","prohibition/ proscription/ veto/ interdiction/interdict/ ban/restriction"));
        arrayList.add(new Contacts(782,"Tacit","implied by","your silence may be taken to mean tacit agreement","0","implicit/understood/implied/ inferred/ hinted/ suggested/ insinuated"));
        arrayList.add(new Contacts(783,"Taint","place under suspicion","the lingering taint of creosote","0","trace/ touch/ suggestion/ hint/ tinge/tincture"));
        arrayList.add(new Contacts(784,"Tangible","that can be touched","the atmosphere of neglect and abandonment was almost tangible","0"," palpable/ tactile/ material/ physical/real/ substantial/ corporeal/ solid"));

        arrayList.add(new Contacts(785,"Tantalizing","arousing expectations and desires","such ambitious questions have long tantalized the world's best thinkers","0","tease/ torment/ torture/ bait/ tempt/entice/ lure/titillate/ intrigue/ allure"));
        arrayList.add(new Contacts(786,"Tantamount","being essential equal to something","the resignations were tantamount to an admission of guilt","0","equivalent to/ equal to/amounting to/ as good as/ more or less/ synonymous with"));
        arrayList.add(new Contacts(787,"Taut","pulled or drawn tight","the fabric stays taut without adhesive","0","flexed/ tensed/ tightened/ hard/ solid/ firm/rigid/stiff/ unyielding"));
        arrayList.add(new Contacts(788,"Temerity","boldness","no one had the temerity to question his conclusions","0","audacity/ boldness/ audaciousness/ nerve/ effrontery/ impudence/ impertinence"));
        arrayList.add(new Contacts(789,"Tenable","based on sound reasoning","such a simplistic approach is no longer tenable","0","defensible/justifiable/ defendable/ supportable/ sustainable/ maintainable"));
        arrayList.add(new Contacts(790,"Tenacious","stubbornly unyielding","a tenacious grip","0","persevering/ persistent/pertinacious/determined/dogged/single-minded/ strong-willed"));
        arrayList.add(new Contacts(791,"Terminate","to end","he was advised to terminate the contract","0","bring to an end/ end/ bring to a close/conclusion/ close/ conclude/ finish/stop/ put an end to"));
        arrayList.add(new Contacts(792,"Terminus","end","the end of a railway or other transport route, or a station at such a point ,a terminal","0","station/ last stop/ end of the line/ terminal/ depot/ garage"));
        arrayList.add(new Contacts(793,"Terse","short","a terse statement","0","curt/ brusque/ abrupt/ clipped/blunt/ gruff/ short/ brief/ concise/ succinct"));
        arrayList.add(new Contacts(794,"Therapy","act of caring","a course of antibiotic therapy","0","treatment/ remedy/ cure/ remedial treatment/ method of healing/salutary"));
        arrayList.add(new Contacts(795,"Throng","large crowd","he pushed his way through the throng","0","crowd/ mass/ multitude/ horde/ host/ mob/ assemblage/ gathering"));
        arrayList.add(new Contacts(796,"Thwart","hinder or prevent","he never did anything to thwart his father","0","prevent/hinder/impede/opaque/block/blur"));
        arrayList.add(new Contacts(797,"Timorous","showing or suffering from nervousness","a timorous voice","0","easily frightened/ lacking courage/ fearful/ apprehensive/ faint-hearted/feeble"));
        arrayList.add(new Contacts(798,"Tinge","color lightly","a mass of white blossom tinged with pink","0","tint/ colour/ dye/ stain/ shade/ suffuse/flush/ imbue/wash/ overlay/bathe "));
        arrayList.add(new Contacts(799,"Tolerate","put up something","a regime unwilling to tolerate dissent","0","allow/ permit/ authorize/ sanction/ condone/ indulge/ agree to/ accede to/ approve of"));
        arrayList.add(new Contacts(800,"Tortuous","marked by turns and bends","the route is remote and tortuous","0","twisting/ winding/ curving/ curvy/ bending/sinuous/ undulating/ coiling"));
        arrayList.add(new Contacts(801,"Tradition","a specific practice","members of different castes have by tradition been associated with specific occupations","0","historical convention/ unwritten law/oral history/heritage/ lore/ folklore/ old wives"));
        arrayList.add(new Contacts(802,"tranquil","calm","her tranquil gaze","0","peaceful/ restful/ reposeful/ calm/ quiet/still/ serene/placid,"));
        arrayList.add(new Contacts(803,"Transient","lasting for short period","a transient cold spell","0","transitory/ temporary/ short-lived/ short-term/ ephemeral/ impermanent/ brief/ short"));
        arrayList.add(new Contacts(804,"Tremulous","quivering as from weakness","he gave a tremulous smile","0","shaking/ unsteady/ quavering/ wavering/ quivering/ quivery/ quaking"));
        arrayList.add(new Contacts(805,"Trenchant","having keenness","the White Paper makes trenchant criticisms of health authorities","0","incisive/ cutting/ pointed/ piercing/ penetrating/ sharp/ keen/acute/razor-sharp"));
        arrayList.add(new Contacts(806,"Trend","a general tendency to change","an upward trend in sale","0","tendency/ movement /drift/ swing/ shift/ course/ current/ run/ direction/ inclination"));
        arrayList.add(new Contacts(807,"Trivial","small and little importance","huge fines were imposed for trivial offences","0","unimportant/ insignificant/ inconsequential/ minor/ of no/little account/ of no/little "));

        arrayList.add(new Contacts(808,"Truncated","to vcut","a truncated cone shape","0","shorten/ cut/ cut short/ curtail/ dock/ prune/ trim/ lop/ abbreviate/ telescope"));
        arrayList.add(new Contacts(809,"Turbulent","unrest","the country's turbulent history","0","empestuous/ stormy/ unstable/ unsettled/ tumultuous/ explosive/ in turmoil/ full of conflict"));
        arrayList.add(new Contacts(810,"Turpitude","a corrupt or depraved or degenerate","act of moral turpitude","0","wickedness/ immorality/ depravity/corruption/ corruptness/ vice/ degeneracy"));
        arrayList.add(new Contacts(811,"Ubiquitous","being present everywhere","his ubiquitous influence was felt by all the family","0","omnipresent/ ever-present/ present everywhere/ everywhere/all-over/ all over the place"));
        arrayList.add(new Contacts(812,"Ultimate","highest in degree","their ultimate aim was to force his resignation","0","eventual/ last/ final/concluding/ conclusive/ terminal/ end/endmost/ furthest"));
        arrayList.add(new Contacts(813,"Umbrage","a feeling of anger","she took umbrage at his remarks","0","take offence/ be offended/ take exception/ bridle/ take something personally/ be aggrieved"));
        arrayList.add(new Contacts(814,"Unconscionable","greatly exceeding bounds","the unconscionable conduct of his son","0","excessive/ unwarranted/ uncalled for/ unreasonable/unfair/inordinate/immoderate"));
        arrayList.add(new Contacts(815,"Unctuous","unpleasantly and excessively flattering","he seemed anxious to please but not in an unctuous way","0","sycophantic/ ingratiating/ obsequious/ fawning/ servile/ self-abasing/ grovelling, "));
        arrayList.add(new Contacts(816,"Undermine","destroy properly","the flow of water had undermined pillars supporting the roof","0","subvert/ sabotage/ threaten/ weaken/ compromise/ diminish/ reduce"));
        arrayList.add(new Contacts(817,"Universal","applicable to or common to all members","universal adult suffrage","0","general/ ubiquitous/ comprehensive/ common/ omnipresent/ all-embracing"));
        arrayList.add(new Contacts(818,"Unmitigated","not dimished or moderated","the tour had been an unmitigated disaster","0","absolute/ unqualified/ unconditional/ categorical/ complete/ total/ thoroughgoing "));
        arrayList.add(new Contacts(819,"Unsavory","morally offensive","they looked at the scanty, unsavoury portions of food doled out to them","0","unpalatable/ unappetizing/ unpleasant/ distasteful/ disagreeable/ uninviting/ unappealing "));
        arrayList.add(new Contacts(820,"Unwieldy","difficult to use or handle","huge, unwieldy arc lamps","0","cumbersome/ unmanageable/ unhandy/ unmanoeuvrable/ awkward/ difficult"));
        arrayList.add(new Contacts(821,"Urbane","showing a high degree of refinement","he is charming and urbane","0","suave/sophisticated/ debonair/ worldly/ elegant/ cultivated/ cultured,"));
        arrayList.add(new Contacts(822,"Usurp","seize or take control","Richard usurped the throne","0","seize/ take over/ expropriate/ take possession of/ take/ appropriate/ steal/ wrest"));
        arrayList.add(new Contacts(823,"Utopia","ideally perfect state","misplaced faith in political utopias has led to ruin","0","ideal place/ paradise/ heaven/ heaven on earth/ Eden/ Garden of Eden/ Shangri-La "));
        arrayList.add(new Contacts(824,"Vacillate","be undecided","I vacillated between teaching and journalism","0","dither/ be indecisive/ be irresolute/ be undecided/ be uncertain/ be unsure/ be doubtful, "));
        arrayList.add(new Contacts(825,"Valor","brave","the medals are awarded for acts of valour","0","bravery/ courage/ fearlessness/ courageousness/ braveness/ intrepidity/ intrepidness "));
        arrayList.add(new Contacts(826,"Vapid","lacking significance","tuneful but vapid musical comedies","0","insipid/ uninspired/ colourless/uninteresting/feeble/flat/ dead/ dull/boring"));
        arrayList.add(new Contacts(827,"Vehemently","in a fierce manner","he vehemently denied any suggestion of improper conduct","0","forcefully/without asking/bully/unretraint/improper/vehement"));
        arrayList.add(new Contacts(828,"Veneer","thin covering","a fine-grained venee","0","covering/film/opaque/sheet/cover/thin"));
        arrayList.add(new Contacts(829,"Venerable","profoundly honored","a venerable statesman","0","respected/venerated/ revered/reverenced/ worshipped/ honoured/esteemed"));
        arrayList.add(new Contacts(830,"Venial","warranting only temporal punishment","we cannot prevent ourselves sometimes from dreaming of performing venial if not mortal sins","0","pardonable/ forgivable/ excusable/ condonable/ tolerable/ permissible/ allowable"));
        arrayList.add(new Contacts(831,"Venom","toxic secreted by animal","snake venoms have different effects","0","rancour/ malevolence/ vitriol/ spite/ spitefulness/ vindictiveness/ malice"));

        arrayList.add(new Contacts(832,"Vertigo","a reeling sensation","The ride caused a vertigo.","0","dizziness/ giddiness/ light-headedness/ loss of balance/ loss of equilibrium/spinning "));
        arrayList.add(new Contacts(833,"Vestige","remains","the last vestiges of colonialism","0","remainder/ fragment/ relic/ echo/ indication/ sign/ trace/mark/ print/imprint"));
        arrayList.add(new Contacts(834,"Vex","irritate","He was trying to vex her.","0","annoy/ irritate/ infuriate/ anger/ incense/ inflame/ enrage/ irk/ chagrin"));
        arrayList.add(new Contacts(835,"Viable","capable of life and normal growth","the proposed investment was economically viable","0"," feasible/ practicable/ practical/ applicable/ usable/ manageable/ operable "));
        arrayList.add(new Contacts(836,"Vigilant","strict","the burglar was spotted by vigilant neighbours","0","watchful/ on the lookout/ observant/ sharp-eyed/ keen-eyed/ gimlet-eyed/ eagle-eyed"));
        arrayList.add(new Contacts(837,"Vilify","spread negative information","he has been vilified in the press","0","disparage/ denigrate/ defame/ run down/ revile/berate/ belittle/ abuse/ insult/ slight, "));
        arrayList.add(new Contacts(838,"Vindicate","to provide proof","hospital staff were vindicated by the inquest verdict","0","acquit/ clear/ absolve/ free from blame/ declare innocent/ exonerate/ exculpate "));
        arrayList.add(new Contacts(839,"Virile","manly","he was a powerful, virile man","0","manly/ masculine/ male/all-male/gallant/ chivalrous/ swashbuckling/ valiant "));
        arrayList.add(new Contacts(840,"Virtuosity","technical skill or fluency","a performance of considerable virtuosity","0","skill/ skilfulness/ mastery/ expertise/ expertness/ prowess/ proficiency/ ability/ aptitude "));
        arrayList.add(new Contacts(841,"Virulent","extremely poisonous","a virulent strain of influenza","0","poisonous/ toxic/ venomous/ noxious/ deadly/ lethal/fatal/mortal/terminal"));
        arrayList.add(new Contacts(842,"Vitiate","make imperfect","development programmes have been vitiated by the rise in population","0","imperfect/spoil/impair/damage/impure/injure"));
        arrayList.add(new Contacts(843,"Vitriolic","harsh or corrosive","vitriolic attacks on the politicians","0","rancorous/ bitter/ caustic/ mordant/ acerbic/ astringent/ acid/acrid "));
        arrayList.add(new Contacts(844,"Vituperative","abusive","a vituperative outburst","0","abusive/invective/bad/noxious/unpleasant/harmful"));
        arrayList.add(new Contacts(845,"Vivacious","vigorous or animated","her vivacious and elegant mother","0","lively/ animated/ full of life/ spirited/ high-spirited/ effervescent/ bubbling/bubbly"));
        arrayList.add(new Contacts(846,"Vogue","a current state of general acceptance","the vogue is to make realistic films","0","trend/ taste/ fad/ fancy/ passing fancy/ craze/ rage/ enthusiasm, "));
        arrayList.add(new Contacts(847,"Volition","the faulty or power of using one's will","without conscious volition she backed into her office","0","fault/prohibition/violate/break/consecrate/unlawful"));
        arrayList.add(new Contacts(848,"Voluminous","large","a voluminous purple cloak.","0","capacious/ commodious/ roomy/ spacious/ ample/ full/ big/ large"));
        arrayList.add(new Contacts(849,"Voracious","devouring or craving food in great","a voravious appetite","0","insatiable/ unquenchable/ unappeasable/ prodigious/ uncontrollable/uncontrolled "));
        arrayList.add(new Contacts(850,"Vulnerable","capable of being wounded","we were in a vulnerable position","0","in danger/ in peril /in jeopardy/ at risk/endangered/ unsafe/ unprotected/ ill-protected"));
        arrayList.add(new Contacts(851,"Wan","pale","she was looking wan and bleary-eyed","0","pale/pallid/ ashen/ white/white as a sheet/grey"));
        arrayList.add(new Contacts(852,"Wane","decline","confidence in the dollar waned","0","decrease/ decline/ diminish/dwindle/ shrink/contract/ taper off/ tail off/ subside"));
        arrayList.add(new Contacts(853,"Wary","cautious","dogs which have been mistreated often remain very wary of strangers","0","cautious/ careful/ circumspect/ on one's guard/ chary/alert/ on the alert/ on the lookout"));
        arrayList.add(new Contacts(854,"Wheedle","influence by gentle urging","she wheedled her way on to the guest list","0","inveigle/ lure/ induce/ blarney/ entice/ charm/ tempt/ beguile/ flatter/ "));
        arrayList.add(new Contacts(855,"Whet","sharpen by rubbing","she took out her dagger and began to whet its blade in even, rhythmic strokes","0","sharpen/ hone/ put an edge on/ strop/ grind/ file/ rareedge/ acuminate"));
        arrayList.add(new Contacts(856,"Whimsical","determined by chance or impulse","a whimsical sense of humour","0","fanciful/ playful/ mischievous/ waggish/quaint/ fantastic/ unusual/curious/ droll"));
        arrayList.add(new Contacts(857,"Wince","draw back","he winced at the disgust in her voice","0","rimace/ pull a face/ flinch/ blench/ start/ draw back/ shrink away/ recoil/ cringe "));
        arrayList.add(new Contacts(858,"Wistful","showing pensive","a wistful smile","0","nostalgic/ yearning/ longing/plaintive/ rueful/ melancholy/ sad/ mournful/ forlorn"));
        arrayList.add(new Contacts(859,"Wrest","obtaining by force","Leila tried to wrest her arm from his hold","0","wrench/ snatch/ seize/ grab/ take by force/ remove by force/ force/prise/peel/ pluck"));
        arrayList.add(new Contacts(860,"Zealous","marked by active interest","the council was extremely zealous in the application of the regulations","0","fervent/ ardent/ fervid/ fiery/passionate/ impassioned/ devout/ devoted"));
        arrayList.add(new Contacts(861,"Zenith","time at which something is most powerful","in 1977, punk was at its zenith","0","highest point/ high point/ crowning point/ height/top/ acme/ peak/ pinnacle/ apex"));
