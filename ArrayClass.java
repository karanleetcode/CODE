...
//d
        ...
        arrayList.add(new Contacts(88,"Repose","freedom","She reposed on the sofa.","0","lie/rely/rest/catnapping/resting/sleep"));
        arrayList.add(new Contacts(89,"Reprehensible","deserving blame","reprehensible conduct/actions","0","culpable/blamable/censurable/blameworthy/reproachable/blame"));
        arrayList.add(new Contacts(90,"Repress","concean or hide","He repressed a sudden desire to cry.","0","subdue/clamp down/crack down/put down/quell/snuff/silence"));
        arrayList.add(new Contacts(91,"Reprimand","to scold","She was reprimanded by her teacher for biting another girl.","0","commination/condemnation/comtempt/reproach/riot/stricture"));
        arrayList.add(new Contacts(92,"Reproach","to criticize","His mother reproached him for not eating all his dinner.","0","commination/condemnation/comtempt/reproach/riot/stricture"));
        arrayList.add(new Contacts(93,"Repudiate","to refuse to achknowledge","He repudiated the allegation/charge/claim that he had tried to deceive them.","0","decline/contradict/disaffirm/negative/refute/deny"));
        arrayList.add(new Contacts(94,"Repugnant","offensive to mind","I find your attitude towards these women quite repugnant.","0","incompatible/hostile/inconsistent/abhorrent/abominable/appalling"));
        arrayList.add(new Contacts(95,"Repulse","force or drive back","The enemy attack was quickly repulsed.","0","repel/repulsion/gross out/nauseate/revolt/sicken"));
        arrayList.add(new Contacts(88,"Requisite","necessary","He lacked the requisite skills for the job.","0","essential/necessary/critical/needed/essential/vital"));
        arrayList.add(new Contacts(89,"Resourceful","adroit and imaginative","She's a very resourceful manager.","0","adroit/skillful/adept/apt/caliber/imaginative"));
        arrayList.add(new Contacts(90,"Respite","a pause from doing something","We worked for hours without respite.","0","interval/put off/delay/relief/temporary delay/stop"));
        arrayList.add(new Contacts(91,"Restrictive","serving to limit","He is self-employed because he finds working for other people too restrictive.","0","restrict/stint/negotiate/limting/fencing/boundry"));
        arrayList.add(new Contacts(92,"Reticent","reserved","He is very reticent about his past.\n","0","silent/reserved/close/closemouthed/dark/secretive/uncommunicative"));
        arrayList.add(new Contacts(93,"Retort","quick reply","\"That doesn't concern you!\" she retorted.","0","return/retaliate/answer/reply/say/counter reply"));
        arrayList.add(new Contacts(94,"Retrospect","look within oneself","In retrospect, I think my marriage was doomed from the beginning.","0","reappraisal/reconsideration/reexamination/review/retrospection/review"));
        arrayList.add(new Contacts(95,"Revere","respect","Nelson Mandela is revered for his brave fight against apartheid.","0","adore/respect/worship/glorify/venerate/reverence/deify"));
 arrayList.add(new Contacts(88,"Revert","turn back","He has to revert back to the sitaution","0","reversion/reverse/retrogress/return/regress/come back"));
        arrayList.add(new Contacts(89,"Revile","abusive language","The minister was attacked by some revile language","0","scold/rail/vituperate/invective/critical/insult"));
        arrayList.add(new Contacts(90,"Rhetoric","study of technique for using language effectively","I was swayed by her rhetoric into donating all my savings to the charity.","0","verbal/language/bombast/fustian/hot air/verbiage/wind"));
        arrayList.add(new Contacts(91,"Rife","abundant","Dysentery and malaria are rife in the refugee camps.","0","abonding/abundant/awash/fraught/flush/swarming/thick"));
        arrayList.add(new Contacts(92,"Rift","a narrow fissure","The stream had cut a deep rift in the rock.","0","breach/fissure/fault/estrangement/cleft/cranny"));
        arrayList.add(new Contacts(93,"Roster","list","If you look on the duty roster, you'll see when you're working.","0","canon/catalog/checklist/listing/menu/registry"));
        arrayList.add(new Contacts(94,"Rudimentary","early stages","Her knowledge is still only rudimentary.","0","vestige/crude/low/rude/primitive/basic/simple"));
        arrayList.add(new Contacts(95,"Rue","feel sorry for","He was quite rueful after his death.","0","sorrow/bemoan/deplore/lament/repent/regret"));
        arrayList.add(new Contacts(88,"Ruminate","reflect deeply","She ruminated for weeks about whether to tell him or not.","0","ponder/chew over/cogitate/consider/debate/contemplate"));
        arrayList.add(new Contacts(89,"Rustic","characteristic of rural life","a rustic bench/cabin","0","clumsy/gauche/graceless/inelegant/awkward/wooden"));
        arrayList.add(new Contacts(90,"Sabbatical","a leave taken every seventh day","to take/have a sabbatical","0","leave/respite/holiday/leave off/sabbath/take off"));
        arrayList.add(new Contacts(91,"Sage","wise saying","my sage old grandfather","0","grave/solemn/wise/discerning/insightful/prudent"));
        arrayList.add(new Contacts(92,"Salient","quality that thrust itself into attention","She began to summarize the salient features/points of the proposal.","0","noticeable/jumping/prominent/conspicously/important/gaudy"));
        arrayList.add(new Contacts(93,"Salubrious","healthy","He doesn't live in a very salubrious part of town.","0","good/healthy/salutary/medicinal/restorative/sanative/salutiferous"));
        arrayList.add(new Contacts(94,"Salvation","preserving from harm","After the diagnosis, getting to know Mary was his salvation.","0","deliverance/rescue/save/safeguard/bodyguard/uncathed"));
        arrayList.add(new Contacts(95,"Sanctimonious","hyptocritically pious","sanctimonious religious leaders preaching about morality","0","holiness/god/sanctity/holy/morals/devout"));
        arrayList.add(new Contacts(88,"Sanction","offical approval","Many nations have imposed sanctions on the country ","0","allowance/authorization/clearance/consent/concurrence/permission/sufferance"));
        arrayList.add(new Contacts(89,"Sanctuary","a concecrated place where sacred objects are kept","Illegal immigrants found/sought/took sanctuary in a local church.","0","shrine/sanctum/refuge/church/temple/room"));
        arrayList.add(new Contacts(90,"Sanguine","optimistic and cheerful","They are less sanguine about the prospects for peace.","0","ruddy/optimistic/ruddy/bloodred/bloodthirsty/confident"));
        arrayList.add(new Contacts(91,"Satiety","to satisfy","A good way to feel satiety and eat healthy while at a party is to fill your plate with vegetables first","0","surfeit/fullness/satisfied/full/satiated/complete"));
        arrayList.add(new Contacts(92,"Saturate","to fill to the brim","The grass had been saturated by overnight rain.","0","soak/satiate/saturate/awash/bathed/bedraggled"));
        arrayList.add(new Contacts(93,"Schism","division of a group into opposing factors","a schism in/within the Church","0","discord/separation/disharmony/division/conflict/disaccord"));
